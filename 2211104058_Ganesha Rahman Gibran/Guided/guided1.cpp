...
Pohon* insertLeft(char data, Pohon *node){
    ...
    node->left = baru;
    cout << "\n Node " << data << " berhasil dibuat menjadi child kiri dari node " << node->data << endl;
    return baru;
}
...
Pohon* insertRight(char data, Pohon *node) {
    ...
    baru = new Pohon{data, NULL, NULL, node};
    node->right=baru;
    cout << "\nNode " << data << " berhasil dibuat menjadi child kanan dari node " << node->data << endl;
    return baru;
}
...
void update(char data, Pohon *node){
    ...
    char temp = node->data;
    node->data = data;
    cout << "\nData node " << temp << " berhasil diupdate menjadi " << data << endl;
}
