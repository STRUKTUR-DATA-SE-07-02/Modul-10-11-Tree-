...
int cari_simpul_daun(Pohon *node) {
    ...
    if (!node->left && !node->right) {
        return 1; // Simpul daun ditemukan, tambahkan 1
    }

    // Jika bukan simpul daun, lanjutkan pencarian di anak kiri dan kanan
...
int main() {
    ...
    // Menghitung dan menampilkan jumlah simpul daun
